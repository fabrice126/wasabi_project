var construct_request = function(artist){
    return  ' PREFIX db-owl: <http://dbpedia.org/ontology/> '+
            ' PREFIX rdf:    <http://www.w3.org/1999/02/22-rdf-syntax-ns#> '+
            ' PREFIX prop:   <http://dbpedia.org/property/> '+
            ' PREFIX dc:      <http://purl.org/dc/terms/> '+
            ' CONSTRUCT { '+
            '		 <http://dbpedia.org/resource/'+artist+'>   db-owl:bandMember                ?bandMemberBand; '+
            ...
            '    }. '+
            '    OPTIONAL {<http://dbpedia.org/resource/'+artist+'> db-owl:associatedMusicalArtist  ?associatedMusicalArtistBand}. '+
            '    OPTIONAL {<http://dbpedia.org/resource/'+artist+'> db-owl:recordLabel              ?recordLabel}. '+
            '    OPTIONAL {<http://dbpedia.org/resource/'+artist+'> db-owl:activeYearsStartYear     ?activeYearsStartYearBand}. '+
            '    OPTIONAL {<http://dbpedia.org/resource/'+artist+'> db-owl:abstract                 ?abstractBand . FILTER langMatches(lang(?abstractBand), "en")} . '+
            '    OPTIONAL { '+
            '        <http://dbpedia.org/resource/'+artist+'> db-owl:formerBandMember ?formerBandMemberBand . '+
